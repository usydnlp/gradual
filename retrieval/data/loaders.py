...
__loaders__ = {
    ...
    #'precomp_sg': {
    #    'class': datasets.PrecompSGDataset,
    #},
    #'precomp_imgsg': {
    #    'class': datasets.PrecompIMGSGDataset,
    #},
    'precomp_bisg': {
        'class': datasets.PrecompBISGDataset,
    },
}
...
def get_loader(
    ...
    **kwargs
    ...
    # datasets.PrecompDataset
    logger.debug(f'Dataset class is {dataset_class}')

    tokenizers = []

    # [.vocab_cache/coco_precomp.json]
    ...
    for val_data in opt.dataset.val.data:
        val_loaders.append(
            get_loader(
                data_split='dev',
                data_path=data_path,
                data_info=val_data, #coco_precomp.en
                loader_name=opt.dataset.loader_name,
                local_rank=local_rank,
                text_repr=opt.dataset.text_repr,
                vocab_paths=opt.dataset.vocab_paths,
